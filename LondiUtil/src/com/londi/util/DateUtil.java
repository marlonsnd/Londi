...
/**
 * Classe utilitaria para manipula��o de datas
 */
public abstract class DateUtil {
    ...
    public static Date lastDayOfWeek(int semana, int ano) {
        ...
        // incrementa aux at� o primeiro dia da semana
    ...
    /**
     * Retorna se � a data padr�o 01/01/1900 ou *** NULL
     *
     ***
    ...
    /**
     * Incrementa n�mero de minutos na data
     * @param date
     * @param minutes
     * @return
     */
    ...
    /**
     * Retorna se time � igual a 00:00:00, hora zero (meia noite)
     *
     * @param time
    ...
    /**
     * Retorna o dia da semana onde o 1 � o domingo, 2 a segunda, .. e 7 o
     * sabado
     *
     * @param data .
    ...
    /**
     * formata um per�odo para visualiza��o reduzida quando possível ex: mesmo
