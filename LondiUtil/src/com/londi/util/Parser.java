...
public class Parser {
    ...
    public static Date strToDate(String date, final String format) throws ParseException {
        if (format != null && !format.isEmpty()) {
                ...
                if (date.length() < 10) {
                    ...
                    if (partes.length == 3) {
                        if (partes[2].length() == 2) {
                            ...
                            throw new ParseException("Formato da data " + date + " está incorreto", 0);
                        }
            ...
            throw new ParseException("Formato (pattern) da data não informado!", 0);
        }
    }
    ...
    /**
     * Tenta converter String para Date senï¿½o devolve data default
     *
     * @param date string com a data
     * @param def data padrão a ser devolvida se o parse falhar
     * @return Date
     * @see java.util.Date
     */
    ...
    /**
     * Formata double em String com numero definido de casas no padrão JAVA
     *
     ...
     *
     * @param bool string contendo S ou true para retornar true senï¿½o false
     * @return boolean
     */
